...
const styles = StyleSheet.create({
  ...
  selectBtnText: { color: '#fff', fontSize: 12, fontWeight: '500' },
  ...
  fontSizeLabel: { color: '#fff', fontSize: 10, marginBottom: 8, textAlign: 'right' },
  ...
  fontSizeValue: { color: '#fff', fontSize: 14, fontWeight: '600', minWidth: 30, textAlign: 'center' },
  ...
  switchLabel: { color: '#fff', fontSize: 12, fontWeight: '600', textAlign: 'right' },
  switchSubLabel: { color: '#555', fontSize: 9, marginTop: 4, textAlign: 'right' },
  ...
  logoutText: { color: '#ff4444', fontWeight: '600', fontSize: 12 },
  infoRow: {
    flexDirection: 'row',
  ...
  modalItemText: { color: '#fff', fontSize: 12, fontWeight: '500' },
});
