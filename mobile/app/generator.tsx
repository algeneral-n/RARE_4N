...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: '#fff', fontSize: 14, fontWeight: '700', letterSpacing: 1 },
  agentStatus: { fontSize: 8, fontWeight: '600', marginTop: 4, textTransform: 'uppercase' },
  ...
  modeLabel: { fontSize: 8, fontWeight: '700' },
  ...
  pickerText: { color: '#555', fontSize: 10 },
  fullImg: { width: '100%', height: '100%' },
  input: { minHeight: 100, textAlignVertical: 'top', color: '#fff', fontSize: 12, marginBottom: 16 },
  ...
  btnText: { color: '#000', fontWeight: '700', fontSize: 12, letterSpacing: 0.5 },
  ...
  resultTitle: { color: '#00ff88', fontSize: 10, fontWeight: '600', marginBottom: 12 },
  resultMedia: { width: '100%', height: 250, borderRadius: 15, backgroundColor: '#000' },
  resultCode: { color: '#aaa', fontSize: 9, fontFamily: Platform.OS === 'ios' ? 'Courier' : 'monospace', marginTop: 12 },
  ...
  subLabel: { color: '#555', fontSize: 9, marginBottom: 6 },
  ...
  engineText: { fontSize: 9, fontWeight: '500' }
});