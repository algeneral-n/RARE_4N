  ...
  async init(): Promise<void> {
    ...
    try {
      ...
      try {
        ...
        console.error('RARE Load long-term memory error:', error);
        // Continue anyway
      }
      ...
      try {
        ...
        console.error('RARE Start cleanup intervals error:', error);
        // Continue anyway
      }

      this.initialized = true;
      console.log('RARE MemoryEngine initialized');
    } catch (error) {
      console.error('RARE MemoryEngine init error:', error);
